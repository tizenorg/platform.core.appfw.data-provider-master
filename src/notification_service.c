...
int notification_register_dbus_interface()
{
	static gchar introspection_xml[] =
			...
			"          <arg type='i' name='visibility_class' direction='in'/>"
			"          <arg type='i' name='schedule_enabled' direction='in'/>"
			"          <arg type='i' name='schedule_day' direction='in'/>"
			"          <arg type='i' name='start_hour' direction='in'/>"
			"          <arg type='i' name='start_min' direction='in'/>"
			"          <arg type='i' name='end_hour' direction='in'/>"
			"          <arg type='i' name='end_min' direction='in'/>"
			"          <arg type='i' name='uid' direction='in'/>"
			"        </method>"
...
int notification_update_noti_sys_setting(GVariant *parameters, GVariant **reply_body, uid_t uid)
{
	...
	DbgPrint("do_not_disturb [%d] visivility_class [%d] set_schedule [%d]\n",
			do_not_disturb, visivility_class, schedule_enabled);
