...
extern struct inst_info * const instance_ref(struct inst_info *inst);
extern struct inst_info * const instance_unref(struct inst_info *inst);
extern struct pkg_info *instance_package(struct inst_info *inst);
extern struct script_info *instance_lb_handle(struct inst_info *inst);
extern struct script_info *instance_pd_handle(struct inst_info *inst);
extern const char *instance_id(struct inst_info *inst);
extern double instance_timestamp(struct inst_info *inst);
extern enum instance_state instance_state(struct inst_info *inst);
 ...
 * getter
 */
extern const char *instance_content(struct inst_info *inst);
extern const char *instance_category(struct inst_info *inst);
extern const char *instance_cluster(struct inst_info *inst);
extern int instance_auto_launch(struct inst_info *inst);
extern int instance_priority(struct inst_info *inst);
extern struct client_node *instance_client(struct inst_info *inst);
extern double instance_period(struct inst_info *inst);
extern int instance_lb_width(struct inst_info *inst);
extern int instance_lb_height(struct inst_info *inst);
extern int instance_pd_width(struct inst_info *inst);
extern int instance_pd_height(struct inst_info *inst);
